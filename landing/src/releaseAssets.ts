...
export const RELEASE_URL = 'https://github.com/98canon/Edgetree/releases/latest'
const RELEASE_API_URL = 'https://api.github.com/repos/98canon/Edgetree/releases/latest'
